...
class DataValidationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.drift_report_filepath = os.path.join(
            self.data_validation_dir,
...
class ModelTrainerConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.trained_model_filepath: str = os.path.join(
            ...
            training_pipeline.MODEL_FILENAME
        )
        self.expected_accuracy: float = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_thrreshold: float = training_pipeline.MODEL_TRAINER_OVERFITTING_UNDERFITTING_THRESHOLD